...
REM
REM Generated by Vivado on Fri Jun 26 04:54:17 +0200 2026
...
echo "xvhdl --incr --relax -prj sync_fifo_tb_vhdl.prj"
call xvhdl  --incr --relax -prj sync_fifo_tb_vhdl.prj -log xvhdl.log
