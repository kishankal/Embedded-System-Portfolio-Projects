...
REM
REM Generated by Vivado on Fri Jul 17 23:07:46 +0200 2026
...
echo "xvhdl --incr --relax -prj uart_loopback_tb_vhdl.prj"
call xvhdl  --incr --relax -prj uart_loopback_tb_vhdl.prj -log xvhdl.log
