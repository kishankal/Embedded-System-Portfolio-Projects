...
REM
REM Generated by Vivado on Thu Jun 25 12:14:38 +0200 2026
...
echo "xvhdl --incr --relax -prj seq_detector_101_tb_vhdl.prj"
call xvhdl  --incr --relax -prj seq_detector_101_tb_vhdl.prj -log xvhdl.log
