...
REM
REM Generated by Vivado on Sun Jun 21 13:22:54 +0200 2026
...
echo "xvhdl --incr --relax -prj mux4to1_tb_vhdl.prj"
call xvhdl  --incr --relax -prj mux4to1_tb_vhdl.prj -log xvhdl.log
