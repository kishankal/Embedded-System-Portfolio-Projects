...
REM
REM Generated by Vivado on Mon Jun 22 18:26:53 +0200 2026
...
echo "xvhdl --incr --relax -prj mod10_counter_tb_vhdl.prj"
call xvhdl  --incr --relax -prj mod10_counter_tb_vhdl.prj -log xvhdl.log
